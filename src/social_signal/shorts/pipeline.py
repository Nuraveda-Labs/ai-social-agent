...
Usage:
    python -m social_signal.shorts.pipeline \\
        --brand glitch_founder \\
        --topic "the methodology bug in my AI ads agent" \\
        --duration 45

Output:
    /var/lib/ai-social-media-agent/videos/shorts/<brand>/<uuid>.mp4
"""
...
from social_signal.shorts.assembler import assemble
from social_signal.shorts.captions import (
    build_ass_subtitles,
    transcribe_words,
    words_json_dump,
)
from social_signal.shorts.motion import animate_all
from social_signal.shorts.script_writer import write_script
from social_signal.shorts.visuals import render_segments
from social_signal.shorts.voice import render_voiceover
