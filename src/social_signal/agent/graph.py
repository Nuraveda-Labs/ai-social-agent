"""LangGraph StateGraph for the AI Social Agent video pipeline.

Two entry paths, chosen per-invocation via `state["content_source"]`:

  ai_generated (default, this project):
...
from social_signal.agent.nodes.quality_check import quality_check_node
from social_signal.agent.nodes.scout import scout_node
from social_signal.agent.nodes.script_writer import script_writer_node
from social_signal.agent.nodes.storyboard import storyboard_node
from social_signal.agent.nodes.text_writer import text_writer_node
from social_signal.agent.nodes.video_assembler import video_assembler_node
from social_signal.agent.nodes.video_generator import video_generator_node
from social_signal.agent.nodes.video_router import video_router_node
from social_signal.agent.state import SignalAgentState
...
def build_graph() -> StateGraph:
    ...
    # ai_generated branch (existing this project pipeline)
